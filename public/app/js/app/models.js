...
App.Models.Stats = App.Models.EmailBoxModel.extend({
	
	// Returns Thread._ids
	// - special kind of caching
	// cacheType: 'ids'

	sync: Backbone.cachingSync(emailbox_sync_model, 'StatsFull'),

	modelName: 'AppMailStatsLatest',
	internalModelName: 'Stats',
	fields: []
